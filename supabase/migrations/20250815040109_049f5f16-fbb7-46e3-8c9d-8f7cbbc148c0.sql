-- Drop and recreate INSERT policy for egg_deliveries table
...
-- Ensure created_by column exists and is properly configured
DO $$ 
BEGIN
    -- Check if created_by column needs to be added or modified
    IF NOT EXISTS (
