  ...
  useEffect(() => {
    const fetchPendingApplications = async () => {
      try {
        ...
        // Fetch applications pending manager review - simplified query
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-lg text-gray-600 mb-6">
          Review and approve loan applications that have been submitted by field officers.
        </p>
              ...
              <Card key={application.id} className="shadow-md">
                <CardHeader className="pb-2">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge className="bg-yellow-500">{application.status}</Badge>
                  </div>
                </CardHeader>
                <CardContent>
