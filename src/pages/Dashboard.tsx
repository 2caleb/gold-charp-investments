          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-gradient-to-br from-blue-50 to-indigo-100 border-blue-200 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent>
                ...
                <p className="text-xs text-blue-600 mt-1">Active client accounts</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-emerald-100 border-green-200 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent>
                ...
                <p className="text-xs text-green-600 mt-1">{overviewData?.approvedLoans || 0} approved</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-violet-100 border-purple-200 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent>
                ...
                <p className="text-xs text-purple-600 mt-1">Payment collection rate</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-orange-50 to-amber-100 border-orange-200 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent>
                ...
                <p className="text-xs text-orange-600 mt-1">Remaining balance</p>
              </CardContent>
            </Card>
          </div>
        </motion.div>
          ...
          <Card className="bg-gradient-to-r from-slate-50 to-gray-100 border-gray-200 shadow-xl">
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center text-xl">
                <Plus className="mr-3 h-5 w-5 text-indigo-600" />
                Quick Actions
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Link to="/new-client">
                  <Button className="w-full h-12 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg transition-all duration-300">
                    <Users className="mr-2 h-4 w-4" />
                    Add New Client
                  </Button>
                </Link>
                <Link to="/new-loan-application">
                  <Button className="w-full h-12 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg transition-all duration-300">
                    <FileText className="mr-2 h-4 w-4" />
                    New Loan Application
                  </Button>
                </Link>
                <Link to="/payments">
                  <Button className="w-full h-12 bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 text-white shadow-lg transition-all duration-300">
                    <CreditCard className="mr-2 h-4 w-4" />
                    Payment Center
                  </Button>
                </Link>
                <Link to="/reports">
                  <Button className="w-full h-12 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white shadow-lg transition-all duration-300">
